...
from paper_embedding import embedding
from peper_detection import detection     # la tua detection file (single file)
...
WM_DIR    = os.path.join(BASE_DIR, "..", "watermarked_images")
ATT_DIR   = os.path.join(BASE_DIR, "..", "attacked_images")   # richiesta: salvare attaccate qui
...
def main():
    ...
    valid_exts = (".bmp", ".png", ".jpg", ".jpeg", ".tif")
