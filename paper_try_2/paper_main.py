...
from paper_try_2.paper_embedding_v1_2 import embedding
from paper_try_2.paper_detection_v1_2 import detection
...
TUNING_SCRIPT = os.path.join(ROOT_DIR, "paper_try_2/tuning_per_image.py")
