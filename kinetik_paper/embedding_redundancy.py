...
def _permute_patterns(bipolar):
    # three simple permutations (you can change to more complex permutations)
    p1 = bipolar.copy()
...
def embedding(input1, input2="ecorp.npy"):
    ...
    p1, p2, p3 = _permute_patterns(bipolar)

    combined = (p1 + p2 + p3) / 3.0
    pattern = combined * sigma
